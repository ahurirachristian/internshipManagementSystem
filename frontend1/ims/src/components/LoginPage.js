      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[440px] flex flex-col p-6 sm:p-10">
        ...
        <div className="text-center mt-5 pt-5 border-t border-slate-200">
          <p className="text-xs text-slate-500 font-medium">
            <Link to="/register" className="text-[#063b33] font-semibold hover:underline">Create an account</Link>
            <span className="mx-2 text-slate-300">|</span>
            <Link to="/forgot-password" className="text-[#063b33] font-semibold hover:underline">Forgot password?</Link>
          </p>
        </div>
      </div>
    </AuthShell>
